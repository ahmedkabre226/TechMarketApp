    ...
    <View style={styles.headerContainer}>
      {showCategories && setShowCategories && (
        <View style={styles.categoriesSidebar}>
          <ThemedText style={styles.sidebarTitle}>Catégories</ThemedText>
            ...
            {categories.map((category) => (
              ...
              >
                <Ionicons
                  ...
                  size={20}
                  color={selectedCategory === category.name ? "#FF9900" : "#666"}
                  style={styles.sidebarIcon}
                />
                <ThemedText style={[
                  styles.sidebarText,
                  selectedCategory === category.name && styles.sidebarTextSelected
                ]}>
                  {category.name}
                </ThemedText>
...
const styles = StyleSheet.create({
  ...
  // Styles pour la barre laterale des categories (drawer gauche)
  categoriesSidebar: {
    position: "absolute",
    left: 0,
